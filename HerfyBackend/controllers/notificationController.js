    ...
    const ARABIC_MESSAGES = {
      ...
      handyman_rejected: { title: 'رفض طلب التوثيق 🔴', body: () => 'تم رفض طلب التوثيق. يرجى مراجعة البيانات' },
      handyman_suspended: { title: 'إيقاف الحساب 🔴', body: () => 'تم إيقاف حسابك مؤقتاً من قبل الإدارة' },
